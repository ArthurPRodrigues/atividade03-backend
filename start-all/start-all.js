...
const services = [
  { name: 'Cadastro de Usuários', script: './cadastro-service/cadastro-service.js' },
  { name: 'Controle de Ingressos', script: './ingresso-service/ingresso-service.js' },
  { name: 'Cadastro de Atrações', script: './atracao-service/atracao-service.js' },
  { name: 'Controle de Filas', script: './fila-service/fila-service.js' },
  { name: 'Estimador de Espera', script: './espera-service/espera-service.js' },
